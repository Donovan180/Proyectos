...
$id_jefe_taller =$_GET['id_jefe_taller'];
$sql=mysqli_query($con,"SELECT id_jefe_taller, nombre, apellido_p, apellido_m, correo, pass, telefono, id_gerente, id_mecanico, tipo_user
                        FROM jefe_taller 
			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<h2>Actualizar</h2>
						<form action="actualizar_emp.php" method="post">
						<input class="input" type="hidden" name="id_jefe_taller" value="<?php echo $id_jefe_taller; ?>">
                        ...
                        <input class="input" type="text" name="id_mecanico" placeholder="ID Mecanico" value="<?php echo $id_mecanico; ?>">
						<input type="submit" class="main-btn" value="Actualizar Registro">	
						<a type="submit" class="main-btn" href="empleados.php" >Cancelar</a>	
						</form>	
						</div>
