...
$sql=mysqli_query($con,"SELECT id_cliente, nombre, apellido_p, apellido_m, correo, telefono, edad, direccion, garantia, id_mecanico,id_automovil 
                        FROM cliente
			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<h2>Actualizar</h2>
						<form action="actualizar_cli.php" method="post">
						<input class="input" type="hidden" name="id_cliente" value="<?php echo $id_cliente; ?>">
						...
						<input class="input" type="text" name="edad" placeholder="Edad" value="<?php echo $edad; ?>" required>
						<input class="input" type="text" name="direccion" placeholder="Dirección" value="<?php echo $direccion; ?>" required>
						<input class="input" type="date" name="garantia" placeholder="Garantía" value="<?php echo $garantia; ?>" required>
						<input class="input" type="text" name="id_mecanico" placeholder="ID Mecanico" value="<?php echo $id_mecanico; ?>" required>
						<input class="input" type="text" name="id_automovil" placeholder="ID Automóvil" value="<?php echo $id_automovil; ?>" required>
						<br><br>
						<input type="submit" class="main-btn" value="Actualizar Registro">	
						<a type="submit" class="main-btn" href="sesion_admin_clientes.php" >Cancelar</a>	
						</form>	
						</div>
