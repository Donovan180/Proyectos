			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<form action="altas_tarea.php" method="post">
						<input class="input" type="text" name="nombre_jefe" placeholder="Nombre Jefe de Taller">
						<input class="input" type="text" name="apellido_p_jefe" placeholder="Apellido P"><br><br>
                            <h2>Altas de Tareas</h2>
                        <input class="input" type="text" name="nombre_mec" placeholder="Nombre Mecánico">
						<input class="input" type="text" name="apellido_p_m" placeholder="Apellido P"><br><br>
                            <textarea name="tareas" placeholder="Tarea"></textarea>
						<br><br>
						<input type="submit" class="main-btn" value="Asignar Tarea">	
						<a type="submit" class="main-btn" href="servicio_jefe.php" >Ver Servicio Relizados</a>	
						</form>	
						</div>
							...
							<div class="main-wrapper" lass="reply-form">
                                    ...
                                    <?php 
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                       <a class="btn btn-primary" href="Editar_tarea.php?id_actividad=<?php echo $row->id_actividad;?>"><img src="img/lapiz.png"></a>
                                            </td>
                                            <td>
                                       <a class="btn btn-primary" href="borrar_tareas.php?id_actividad=<?php echo $row->id_actividad;?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                        <?php } ?>
                                    </table>
