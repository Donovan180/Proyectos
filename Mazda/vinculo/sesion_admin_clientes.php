							...
							<ul class="blog-meta">
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><a type="submit" class="btn btn-primary" href="Editar_cli.php?id_cliente=<?php echo $row->id_cliente;?>"><img src="img/lapiz.png"></a></td>
                                        <td>
                                   <a class="btn btn-primary" href="borrar_clientes.php?id_cliente=<?php echo $row->id_cliente;?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </table></center>
