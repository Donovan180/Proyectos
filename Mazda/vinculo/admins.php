			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<h2>Altas de Gerentes</h2>
						<form action="admin_altas.php" method="post">
						<input class="input" type="text" name="nom" placeholder="Nombre" required>
						<input class="input" type="text" name="apellido_p" placeholder="Apellido P" required>
						<input class="input" type="text" name="apellido_m" placeholder="Apellido M" required>
						<input class="input" type="text" name="correo" placeholder="Correo" required>	
						...
						<input class="input" type="text" name="id_jefe_taller" placeholder="ID Jefe" required>
							...
							<div class="main-wrapper" lass="reply-form">
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td><a type="submit" class="btn btn-primary" href="Editar_admin.php?id_gerente=<?php echo $row->id_gerente;?>"><img src="img/lapiz.png"></a></td>
                                        <td>
                                   <a class="btn btn-primary" href="borrar_admins.php?id_gerente=<?php echo $row->id_gerente;?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                                        </td>
			...
			<div class="row">
				...
				<div class="col-md-12">
					...
					<div class="footer-logo">
						<a href="index.html"><img src="img/mazda-logo1.png" alt="logo"></a>
					</div>
					<!-- /footer logo -->
