			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<h2>Altas de Mecánico</h2>
						<form action="altas_mec.php" method="post">
						...
						<input class="input" type="text" name="id_jefe_taller" placeholder="ID Jefe">
						<input class="input" type="text" name="id_cliente" placeholder="ID Cliente">
						<br><br>
						...
						<div class="blog-content">
							...
							<div class="main-wrapper" lass="reply-form">
                                <h2>Bajas de Mecánicos </h2>
                                <br><br>

                                <?php
                                    include("funcion_mec.php");
                                ?>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                   <a class="btn btn-primary" href="Editar_mec.php?id_mecanico=<?php echo $row->id_mecanico;?>"><img src="img/lapiz.png"></a>
                                        </td>
                                        <td>
                                   <a class="btn btn-primary" href="borrar_mec.php?id_mecanico=<?php echo $row->id_mecanico;?>"><i class="fa fa-trash-o fa-lg" aria-hidden="true"></i></a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </table>
