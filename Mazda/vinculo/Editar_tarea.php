...
$sql=mysqli_query($con,"SELECT id_actividad, nombre_jefe, apellido_jefe, tarea, nombre_mec, apellido_mec
...
if($resul==0){
	...
	while($data = mysqli_fetch_array($sql)){
		...
		$nom_jefe=$data['nombre_jefe'];
		$apellido_jefe=$data['apellido_jefe'];
		$tarea=$data['tarea'];
		$nom_mec=$data['nombre_mec'];
		$apellido_mec=$data['apellido_mec'];
			...
			<div class="row">
				...
				<main id="main" class="col-md-9">
					<div class="blog">
						...
						<input class="input" type="text" name="nom_jefe" placeholder="Nombre"  value="<?php echo $nom_jefe; ?>">
						<input class="input" type="text" name="apellido_jefe" placeholder="Apellido P"  value="<?php echo $apellido_jefe; ?>" required><br><br>
                        <h2>Altas de Tareas</h2>
						<input class="input" type="text" name="nom_mec" placeholder="Nombre Mecánico" value="<?php echo $nom_mec; ?>">
						<input class="input" type="text" name="apellido_mec" placeholder="Apellido P" value="<?php echo $apellido_mec; ?>">
                        <textarea name="tareas" placeholder="Tarea"><?php echo $tarea; ?></textarea>
						<br><br>
						<input type="submit" class="main-btn" value="Actualizar">	
						<a type="submit" class="main-btn" href="tareas.php" >Cancelar</a>	
						</form>	
						</div>
